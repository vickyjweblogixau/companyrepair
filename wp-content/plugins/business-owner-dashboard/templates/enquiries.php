...
<div class="bod-enquiries-page">
    ...
    <?php else : ?>
        ...
        ?>
            <div class="card" style="border-radius:12px;<?php echo $is_new ? 'border-left:4px solid #f97316;' : ''; ?>">
                <div class="card-body" style="padding:20px 24px;">
                    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;">
                        <div>
                            <div style="display:flex;align-items:center;gap:10px;">
                                <div style="width:38px;height:38px;border-radius:50%;background:#f97316;color:#fff;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:14px;">
                                ...
                                <div>
                                    ...
                                    <?php if ($is_new) : ?>
                                        <span style="margin-left:6px;padding:2px 8px;background:#f97316;color:#fff;border-radius:10px;font-size:10px;font-weight:700;">NEW</span>
                                    <?php endif; ?>
                                    <div style="font-size:12px;color:#888;">
                                        <a href="mailto:<?php echo esc_attr($enquiry->comment_author_email); ?>" style="color:#f97316;"><?php echo esc_html($enquiry->comment_author_email); ?></a>
                    ...
                    <?php if ($post) : ?>
                        <div style="font-size:12px;color:#888;margin-bottom:8px;">
                            ...
                            echo (int) $l;
                            ?>" style="color:#f97316;"><?php echo esc_html($post->post_title); ?></a>
                        </div>
                    <?php endif; ?>
                    ...
                    ?>
                        <div style="font-size:13px;margin-bottom:10px;">
                            <strong>Phone:</strong> <a href="tel:<?php echo esc_attr($phone); ?>" style="color:#f97316;"><?php echo esc_html($phone); ?></a>
                        </div>
                    <?php endif; ?>
