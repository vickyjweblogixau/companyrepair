    ...
    <div style="display:flex;gap:8px;margin-bottom:20px;flex-wrap:wrap;">
        ...
        ?>
            <a href="?view=listings<?php echo $tab ? '&status=' . $tab : ''; ?>"
               ...
               <?php echo $active_tab ? 'background:#f97316;color:#fff;' : 'background:#f5f5f5;color:#555;'; ?>">
        ...
        ?>
            <div class="col-md-6 col-xl-4">
                <div class="card" style="border-radius:12px;height:100%;">
                    ...
                    <?php else : ?>
                        <div style="height:140px;background:linear-gradient(135deg,#f97316,#ea580c);border-radius:12px 12px 0 0;display:flex;align-items:center;justify-content:center;">
                    ...
                    <div class="card-body" style="padding:16px;">
                        ...
                        <?php if ($listing->active_boost && $listing->active_boost !== 'none') : ?>
                            <div style="margin-bottom:8px;">
                                <span style="display:inline-block;padding:2px 8px;border-radius:4px;font-size:11px;font-weight:600;background:#fff3e0;color:#f97316;">
