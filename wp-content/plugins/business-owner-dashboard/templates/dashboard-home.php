...
<div class="bod-dashboard-home">
    ...
    <div class="row g-3 mb-4">
        <?php
        $stats = [
            ['Available Credits',  $owner->available_listing_credits ?? 0, 'ti ti-credit-card',   '#f97316'],
            ...
            <div class="card" style="border-radius:12px;">
                <div class="card-body" style="padding:20px 24px;">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
                        ...
                        <a href="?view=listings" style="color:#f97316;font-size:13px;text-decoration:none;">View All →</a>
                    </div>
                        ...
                        <table style="width:100%;border-collapse:collapse;">
                            ...
                            ?>
                                <tr style="border-bottom:1px solid #f5f5f5;">
                                    ...
                                    <td style="padding:10px 0;">
                                        <?php echo $listing->active_boost !== 'none' ? '<span style="color:#f97316;font-weight:600;font-size:12px;">' . esc_html(ucfirst($listing->active_boost)) . '</span>' : '<span style="color:#bbb;">—</span>'; ?>
                                    </td>
                                    <td style="padding:10px 0;font-size:12px;color:#888;">
                                        <?php echo bod_format_datetime($listing->created_at, 'M j, Y'); ?>
                                    </td>
                                    <td style="padding:10px 0;">
                                        <a href="?view=listing-detail&listing_id=<?php echo $listing->id; ?>" style="color:#f97316;font-size:12px;">View</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
        ...
        <div class="col-lg-4">
            <div class="card" style="border-radius:12px;">
                <div class="card-body" style="padding:20px 24px;">
                    ...
                    <a href="?view=profile" style="display:block;margin-top:16px;text-align:center;padding:8px;border:1px solid #f97316;border-radius:6px;color:#f97316;text-decoration:none;font-weight:600;font-size:13px;">Edit Profile</a>
                </div>
            </div>
        </div>
    </div>
