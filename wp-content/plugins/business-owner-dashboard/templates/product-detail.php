...
<div class="bod-listing-detail">
    ...
    <?php if ($is_new && ($owner->available_listing_credits ?? 0) < 1) : ?>
        <div class="alert alert-warning">
            ...
            <a href="?view=subscription" style="color:#f97316;font-weight:600;">Purchase a listing credit</a> to create a listing.
        </div>
    <?php endif; ?>
                    ...
                    <div class="card-body" style="padding:20px;">
                        ...
                        <?php if ($listing->active_boost && $listing->active_boost !== 'none') : ?>
                            <div style="padding:8px 12px;background:#fff3e0;border-radius:6px;margin-bottom:12px;">
                                <strong style="color:#f97316;">Active: <?php echo esc_html(ucfirst($listing->active_boost)); ?> Boost</strong>
                            </div>
                        <?php endif; ?>

                        <?php
                        $boosts = [
                            'featured'  => ['Featured', BOD_BOOST_FEATURED_DISPLAY,  '#f97316'],
                ...
                <div class="card" style="border-radius:12px;">
                    <div class="card-body" style="padding:20px;">
                        ...
                        <div style="margin-top:12px;padding:10px;background:#fff7f0;border-radius:6px;">
                            <strong style="color:#f97316;">Credits Available:</strong>
                            <span style="font-size:18px;font-weight:700;color:#f97316;margin-left:8px;"><?php echo (int) ($owner->available_listing_credits ?? 0); ?></span>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
