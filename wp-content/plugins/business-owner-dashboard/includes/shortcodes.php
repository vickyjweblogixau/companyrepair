...
function bod_render_success_page($atts) {
    ...
    <div style="max-width:580px;margin:0 auto;text-align:center;padding:40px 20px;">
        ...
        <p>
            <a href="<?php echo home_url('/business-owner-login/'); ?>" style="display:inline-block;background:#1565d8;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:700;font-size:16px;">Login to Dashboard</a>
        </p>
