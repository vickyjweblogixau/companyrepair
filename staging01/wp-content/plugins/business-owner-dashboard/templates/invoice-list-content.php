                    ...
                    <table style="width:100%;border-collapse:collapse;min-width:600px;">
                        ...
                        ?>
                            <tr style="border-bottom:1px solid #f5f5f5;">
                                <td style="padding:14px 12px;font-weight:600;font-size:13px;color:#0a2647;"><?php echo esc_html($invoice_num); ?></td>
        ...
        <div class="card" style="border-radius:12px;margin-top:16px;">
            <div class="card-body" style="padding:20px 24px;">
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    ...
                    <div style="font-size:22px;font-weight:700;color:#0a2647;">
                        $<?php
...
.brand { font-size: 24px; font-weight: 700; color: #0a2647; }
...
th { background: #0a2647; color: #fff; padding: 10px 12px; text-align: left; font-size: 13px; }
